...
/[This post was derived from a [[https://github.com/reindeereffect/reindeereffect.github.io/tree/master/production/notebooks/regex.ipynb][Jupyter notebook]].]/
...
trot out perhaps the most famous [[https://stackoverflow.com/questions/1732348/regex-match-open-tags-except-xhtml-self-contained-tags/1732454#1732454][Stackoverflow answer of all time]], it also
...
where /Q/ is a set of states; /q/0 ∈ /Q/ is the starting state; /F/ ⊆ /Q/ is the
...
ε-transitions created by =RE= as it's operators did their work.  Converting it
